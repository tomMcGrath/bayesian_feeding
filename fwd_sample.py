...
def sample(tmax, theta, x0, init_state='F'):
    ...
    while t < tmax or state == 'L' or state == 'S':
        ...
        if state == 'F':
            ...
            #x_segment = integrate.odeint(ODEs.feeding_ode, g_start, f_length, args=(rate,))[:,0]
        ...
        ## Short pause code
            ...
            ## Integrate forward
            g_end_feeding = x[-1]
            #p_length = np.linspace(0, t_plus, t_plus) # integrate at 1-second resolution
            #x_segment = integrate.odeint(ODEs.digestion_ode, g_end_feeding, p_length, args=(k2,))[:,0]
        ...
        ## Long pause code
            ...
            if t_plus > 12*60*60:
                t_plus = 12*60*60 ## avoid crazily long pauses leading to out of memory errors
